Esta versão simplificada executa automaticamente uma demonstração do sistema usando dados pré-definidos, sem a necessidade de interação do usuário. Ela mostra todas as funcionalidades do sistema FIFO:
